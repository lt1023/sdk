...
.method public run(Landroidx/media2/session/MediaSession$ControllerInfo;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    const-string v3, "replacePlaylistItem(): Ignoring empty mediaId from "
    ...
    .line 942
    :cond_1
    iget-object v1, p0, Landroidx/media2/session/MediaSessionStub$27;->this$0:Landroidx/media2/session/MediaSessionStub;
    ...
    iget v2, p0, Landroidx/media2/session/MediaSessionStub$27;->val$index:I

    invoke-interface {v1, v2, v0}, Landroidx/media2/session/MediaSession$MediaSessionImpl;->replacePlaylistItem(ILandroidx/media2/common/MediaItem;)Lcom/google/common/util/concurrent/ListenableFuture;
