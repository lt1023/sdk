...
.method public run()V
    ...
    .line 340
    invoke-virtual {v1, v2}, Landroidx/media/MediaBrowserServiceCompat$Result;->sendError(Landroid/os/Bundle;)V
    ...
    .line 346
    .local v1, "sessionResult":Landroidx/media2/session/SessionResult;
    if-eqz v1, :cond_2

    .line 347
    iget-object v2, p0, Landroidx/media2/session/MediaLibraryServiceLegacyStub$6;->val$result:Landroidx/media/MediaBrowserServiceCompat$Result;

    invoke-virtual {v1}, Landroidx/media2/session/SessionResult;->getCustomCommandResult()Landroid/os/Bundle;
