...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 133
    new-instance v0, Landroidx/media2/player/subtitle/ClosedCaptionWidget$1;

    invoke-direct {v0, p0}, Landroidx/media2/player/subtitle/ClosedCaptionWidget$1;-><init>(Landroidx/media2/player/subtitle/ClosedCaptionWidget;)V

    iput-object v0, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mCaptioningListener:Landroid/view/accessibility/CaptioningManager$CaptioningChangeListener;
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->setLayerType(ILandroid/graphics/Paint;)V
    ...
    iput-object v0, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mManager:Landroid/view/accessibility/CaptioningManager;
    ...
    iput-object v0, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mCaptionStyle:Landroid/view/accessibility/CaptioningManager$CaptionStyle;
    ...
    iput-object v0, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mClosedCaptionLayout:Landroidx/media2/player/subtitle/ClosedCaptionWidget$ClosedCaptionLayout;
    ...
    iget-object v1, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mCaptionStyle:Landroid/view/accessibility/CaptioningManager$CaptionStyle;
    ...
    iget-object v1, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mManager:Landroid/view/accessibility/CaptioningManager;

    invoke-virtual {v1}, Landroid/view/accessibility/CaptioningManager;->getFontScale()F

    move-result v1

    invoke-interface {v0, v1}, Landroidx/media2/player/subtitle/ClosedCaptionWidget$ClosedCaptionLayout;->setFontScale(F)V
    ...
    invoke-virtual {p0, v0, v1, v1}, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->addView(Landroid/view/View;II)V
...
.method private manageChangeListener()V
    ...
    iget-object v2, p0, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->mCaptioningListener:Landroid/view/accessibility/CaptioningManager$CaptioningChangeListener;
...
.method public setOnChangedListener(Landroidx/media2/player/subtitle/SubtitleTrack$RenderingWidget$OnChangedListener;)V
    .locals 0
    .param p1, "listener"    # Landroidx/media2/player/subtitle/SubtitleTrack$RenderingWidget$OnChangedListener;
...
.method public setSize(II)V
    ...
    invoke-virtual {p0, v2, v2, p1, p2}, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->layout(IIII)V
...
.method public setVisible(Z)V
    ...
    invoke-virtual {p0, v0}, Landroidx/media2/player/subtitle/ClosedCaptionWidget;->setVisibility(I)V
