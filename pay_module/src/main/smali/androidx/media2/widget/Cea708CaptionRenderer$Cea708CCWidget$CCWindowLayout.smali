...
.method constructor <init>(Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mRowLimit:I
    ...
    iput-object v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mBuilder:Landroid/text/SpannableStringBuilder;
    ...
    iput-object v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCharacterStyles:Ljava/util/List;

    .line 765
    const/4 v0, -0x1

    iput v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mRow:I

    .line 784
    new-instance v0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;

    invoke-direct {v0, p1, p2}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;-><init>(Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget;Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCView:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput v1, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mFontScale:F
    ...
    invoke-virtual {p0, v1}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->setCaptionStyle(Landroid/view/accessibility/CaptioningManager$CaptionStyle;)V

    .line 794
    iget-object v1, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCView:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;

    const-string v2, ""

    invoke-virtual {v1, v2}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;->setText(Ljava/lang/CharSequence;)V
...
.method private updateText(Ljava/lang/String;Z)V
    ...
    .line 1156
    iget-object v1, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCharacterStyles:Ljava/util/List;
    ...
    iget v3, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mRowLimit:I
    ...
    iget-object v7, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mBuilder:Landroid/text/SpannableStringBuilder;
    ...
    .line 1179
    iget-object v3, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCView:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;

    iget-object v6, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mBuilder:Landroid/text/SpannableStringBuilder;

    invoke-virtual {v3, v6}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;->setText(Ljava/lang/CharSequence;)V
...
.method private updateTextSize()V
    ...
    iget-object v4, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCaptionStyle:Landroid/view/accessibility/CaptioningManager$CaptionStyle;
    ...
    .line 1113
    .local v7, "width":F
    iget-object v8, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCLayout:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;

    invoke-virtual {v8}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;->getWidth()I
    ...
    .line 1119
    :cond_3
    iget v6, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mFontScale:F

    mul-float v6, v6, v5

    iput v6, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mTextSize:F

    .line 1120
    iget-object v6, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCView:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;

    iget v7, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mTextSize:F

    invoke-virtual {v6, v7}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;->setTextSize(F)V
...
.method private updateWidestChar()V
    ...
    .line 1089
    iput-object v4, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mWidestChar:Ljava/lang/String;
...
.method public initWindow(Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;Landroidx/media2/widget/Cea708CCParser$CaptionWindow;)V
    .locals 22
    .param p1, "ccLayout"    # Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;
    .param p2, "captionWindow"    # Landroidx/media2/widget/Cea708CCParser$CaptionWindow;
    ...
    invoke-virtual {v3, v0}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V
    ...
    .line 952
    :goto_1
    iget v3, v2, Landroidx/media2/widget/Cea708CCParser$CaptionWindow;->anchorVertical:I

    int-to-float v3, v3

    iget-boolean v4, v2, Landroidx/media2/widget/Cea708CCParser$CaptionWindow;->relativePositioning:Z
    ...
    .line 957
    .local v3, "scaleRow":F
    iget v4, v2, Landroidx/media2/widget/Cea708CCParser$CaptionWindow;->anchorHorizontal:I

    int-to-float v4, v4

    iget-boolean v6, v2, Landroidx/media2/widget/Cea708CCParser$CaptionWindow;->relativePositioning:Z
    ...
    .line 991
    .local v14, "gap":F
    iget v15, v2, Landroidx/media2/widget/Cea708CCParser$CaptionWindow;->columnCount:I
    ...
    .line 995
    iget-object v1, v0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mWidestChar:Ljava/lang/String;
    ...
    iget-object v6, v0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCaptionStyle:Landroid/view/accessibility/CaptioningManager$CaptionStyle;
    ...
    .line 999
    iget v6, v0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mTextSize:F
    ...
    invoke-virtual {v1}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;->getWidth()I
    ...
    iget-object v5, v0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCLayout:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;

    .line 1002
    invoke-virtual {v5}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;->getWidth()I
    ...
    invoke-virtual {v5, v6}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;->setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    .line 983
    iget-object v1, v0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mCCView:Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;

    sget-object v5, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    invoke-virtual {v1, v5}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCView;->setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    new-instance v5, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$ScaledLayout$ScaledLayoutParams;
    ...
    invoke-direct/range {v16 .. v21}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$ScaledLayout$ScaledLayoutParams;-><init>(Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$ScaledLayout;FFFF)V

    invoke-virtual {v1, v0, v5}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCLayout;->addOrUpdateViewToSafeTitleArea(Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$ScaledLayout$ScaledLayoutParams;)V
    ...
    .line 1058
    invoke-virtual {v0, v7}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->setGravity(I)V
...
.method public onLayoutChange(Landroid/view/View;IIIIIIII)V
    ...
    .line 1072
    .local v1, "height":I
    iget v2, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mLastCaptionLayoutWidth:I

    if-ne v0, v2, :cond_1

    iget v2, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mLastCaptionLayoutHeight:I
    ...
    :cond_1
    :goto_0
    iput v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mLastCaptionLayoutWidth:I

    .line 1074
    iput v1, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mLastCaptionLayoutHeight:I
...
.method public setPenAttr(Landroidx/media2/widget/Cea708CCParser$CaptionPenAttr;)V
    .locals 4
    .param p1, "penAttr"    # Landroidx/media2/widget/Cea708CCParser$CaptionPenAttr;
    ...
    .line 847
    :goto_2
    iget v0, p1, Landroidx/media2/widget/Cea708CCParser$CaptionPenAttr;->penOffset:I
...
.method public setPenColor(Landroidx/media2/widget/Cea708CCParser$CaptionPenColor;)V
    .locals 0
    .param p1, "penColor"    # Landroidx/media2/widget/Cea708CCParser$CaptionPenColor;
...
.method public setPenLocation(II)V
    ...
    .line 864
    iget v0, p0, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->mRow:I
    ...
    invoke-virtual {p0, v1}, Landroidx/media2/widget/Cea708CaptionRenderer$Cea708CCWidget$CCWindowLayout;->appendText(Ljava/lang/String;)V
