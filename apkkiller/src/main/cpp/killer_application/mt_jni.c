...
//
//    XH_LOG_ERROR("apkPath__: %s", apkPath__);
//    XH_LOG_ERROR("repPath__: %s", repPath__);
...
static void inithook( const char* apkPath, const char* repPath){
//    apkPath__ = (*env)->GetStringUTFChars(env, apkPath, 0);
//    repPath__ = (*env)->GetStringUTFChars(env, repPath, 0);
