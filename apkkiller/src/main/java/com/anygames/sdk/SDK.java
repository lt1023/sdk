...
import com.ahaworld.ahaworld.R;
...
//        }).start();
        ...
        MetaAdApi.get().init(application, "1666909673", new InitCallback() {
            @Override
...
//        showTourial(application);
    }
    public static void initKiller(Context application) {
        KillerApplication.init(application);
    }
